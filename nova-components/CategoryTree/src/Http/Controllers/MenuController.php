...
namespace Fereron\CategoryTree\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Fereron\CategoryTree\MenuBuilder;
use Fereron\CategoryTree\Models\Menu;
use Fereron\CategoryTree\Http\Requests\MenuItemFormRequest;
...
class MenuController extends Controller
{
    ...
    public function getMenuItems(Request $request, $menuId): Response
    {
        ...
        $menuItems = $menu->rootMenuItems()->get();
    ...
    public function createMenuItem(MenuItemFormRequest $request): Response
    {
     ...
     * Updates a MenuItem.
     *
     * @param Fereron\CategoryTree\Http\Requests\MenuItemFormRequest $request
     * @param $menuItem
     * @return Illuminate\Http\Response
     **/
