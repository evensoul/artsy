...
namespace Fereron\CategoryTree;
...
class MenuBuilder extends Tool
{
    ...
    {
        return config('nova-menu.resource', \Fereron\CategoryTree\Nova\Resources\MenuResource::class);
    }
    ...
    {
        return config('nova-menu.menu_model', \Fereron\CategoryTree\Models\Menu::class);
    }

    public static function getMenuItemClass()
    {
        return config('nova-menu.menu_item_model', \Fereron\CategoryTree\Models\MenuItem::class);
    }
